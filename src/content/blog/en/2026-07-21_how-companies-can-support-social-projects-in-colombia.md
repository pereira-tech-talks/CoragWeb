...
1. **Align it with the company's real values.** Anything imposed from outside does not last.
2. **Involve teams in the design**, not only the execution.
3. **Measure and communicate**, internally and externally.
4. **Sustain the commitment over time.**
5. **Integrate it into strategy**, not as an appendix to the business.
...
- [What corporate social responsibility actually is](/en/blog/what-corporate-social-responsibility-is)
- [Why social impact matters for modern companies](/en/blog/why-social-impact-matters-for-modern-companies)
- [How to create social impact from scratch, step by step](/en/blog/how-to-create-social-impact-from-scratch)
