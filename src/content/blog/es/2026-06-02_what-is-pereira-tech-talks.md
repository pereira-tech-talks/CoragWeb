...
La larga empieza en un salón de la UTP.

## Febrero de 2014: ocho personas en un salón

El primer meetup se llamó PereiraJS. Ocho personas llegaron. Daniel Aristizabal dio la bienvenida. Jhonber Jimenez y Manuel Pineda dictaron una charla sobre historia y aplicaciones de JavaScript. No había grabación. No había patrocinador. No había plantilla de slides. Había la apuesta más simple que una comunidad puede hacer: **aparecer, compartir lo que sabes, ver quién más le importa**.

Doce años y 84 meetups después, esa misma apuesta es lo que mantiene viva a Pereira Tech Talks. El formato cambió. La marca cambió. El stack cambió. La apuesta no.

## Los cuatro programas que operamos hoy

Pereira Tech Talks no es "un grupo de meetups". Son cuatro programas operando en paralelo, diseñados para servir a la comunidad en distintos niveles de compromiso.

### 1. Meetups mensuales

Cada mes, en la tercera semana, la comunidad se reúne — físicamente en Pereira y por [Luma](https://luma.com/pertechtalks) en línea para quienes están remotos. El formato es consistente: dos charlas técnicas de 25 a 45 minutos cada una, micrófono abierto para lightning talks, comida y conversación. Hemos sostenido esta cadencia — con interrupciones virtuales durante COVID — desde 2014. Es el corazón de todo lo demás.
...
Tres cosas pasaron en los últimos doce años que creo que vale la pena nombrar con honestidad:

**Uno.** Pereira Tech Talks fue reconocida como una comunidad destacada por la Asociación de Egresados de la UTP en 2018. Eso importó localmente porque tendió un puente entre la comunidad voluntaria y la academia.
