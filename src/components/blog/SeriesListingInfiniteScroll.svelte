...
{#if renderedSeries.length === 0 && !loading}
  <div class="text-center py-16">
    <div class="w-16 h-16 mx-auto mb-4 rounded-full bg-corag-primary-soft flex items-center justify-center">
      <svg class="w-8 h-8 text-corag-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
...
{:else}
    ...
    <div class="main-container space-y-6">
      {#each renderedSeries as series, index}
        ...
        <a
          ...
          class="group block bg-corag-bg-elevated rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-corag-border hover:border-corag-primary/40 hover:-translate-y-1"
          ...
          <div class="md:flex md:h-[320px] {index % 2 !== 0 ? 'md:flex-row-reverse' : ''}">
            ...
            <div class="relative md:w-1/2">
              {#if hero}
                ...
                />
              {:else}
                <div class="w-full h-56 md:h-full bg-corag-primary-soft flex items-center justify-center">
                  <svg class="w-16 h-16 text-corag-primary/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                  </svg>
                </div>
              {/if}
            ...
            <div class="md:w-1/2 p-6 lg:p-8 flex flex-col justify-center overflow-hidden">
              <div class="mb-3">
                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-corag-primary-soft text-corag-primary text-xs font-medium">
              ...
              <h2 class="text-xl lg:text-2xl font-bold text-corag mb-3 group-hover:text-corag-primary transition-colors line-clamp-2">
                {t.seriesNames[series.slug] || series.title}
              </h2>
              {#if series.description}
                <p class="text-sm lg:text-base text-corag-secondary mb-5 line-clamp-3">
                  {t.seriesDescriptions[series.slug] || series.description}
                </p>
              {/if}
              <span class="inline-flex items-center gap-1.5 text-sm font-semibold text-corag-primary group-hover:translate-x-1 transition-transform">
  ...
  {:else}
    ...
    <div class="main-container grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {#each renderedSeries as series, index}
        ...
        <a
          href={`${prefix}/blog/series/${series.slug}/`}
          class="group block bg-corag-bg-elevated rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-corag-border hover:border-corag-primary/40 hover:-translate-y-1.5
        ...
        >
            ...
            <div class="lg:flex">
              <div class="relative lg:w-1/2 xl:w-3/5">
                {#if hero}
                  ...
                  />
                {:else}
                  <div class="w-full h-56 lg:h-full lg:min-h-[280px] bg-corag-primary-soft flex items-center justify-center">
                    <svg class="w-16 h-16 text-corag-primary/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                  </div>
              ...
              <div class="lg:w-1/2 xl:w-2/5 p-6 lg:p-8 flex flex-col justify-center">
                ...
                <h2 class="text-xl lg:text-2xl font-bold text-corag mb-3 group-hover:text-corag-primary transition-colors">
                  {t.seriesNames[series.slug] || series.title}
                </h2>
                {#if series.description}
                  <p class="text-sm lg:text-base text-corag-secondary mb-5 line-clamp-3">
          ...
          {:else}
            ...
            <div class="relative">
              ...
              {:else}
                <div class="w-full h-48 bg-corag-primary-soft flex items-center justify-center">
                  <svg class="w-14 h-14 text-corag-primary/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                  </svg>
                </div>
              {/if}
            ...
            <div class="p-5">
              <h2 class="text-lg font-bold text-corag mb-2 group-hover:text-corag-primary transition-colors">
                {t.seriesNames[series.slug] || series.title}
              </h2>
              {#if series.description}
                <p class="text-sm text-corag-secondary mb-4 line-clamp-2">
                  {t.seriesDescriptions[series.slug] || series.description}
                </p>
              {/if}
              <div class="flex items-center justify-between">
                ...
                <span class="text-xs font-semibold text-corag-primary group-hover:translate-x-1 transition-transform">
  ...
  {#if allLoaded && renderedSeries.length > 0}
    <div class="flex flex-col items-center pt-12 pb-6">
      <div class="w-12 h-12 mb-4 rounded-full bg-corag-primary-soft flex items-center justify-center shadow-sm">
        <svg class="w-6 h-6 text-corag-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
        </svg>
      </div>
      <p class="text-sm font-medium text-corag mb-1">
        {lang === 'es'
      ...
      <p class="text-xs text-corag-secondary">
