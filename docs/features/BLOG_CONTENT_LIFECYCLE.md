...
- **Dev (direct URL):** Accessible by direct URL (e.g., `http://localhost:9999/blog/demo-hero-banner/`)
...
- English: `http://localhost:9999/blog/{slug}/`
- Spanish: `http://localhost:9999/es/blog/{slug}/`

Example: `http://localhost:9999/blog/demo-hero-banner/`
