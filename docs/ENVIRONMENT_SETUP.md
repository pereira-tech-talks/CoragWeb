...
| `CONTACT_ALLOWED_ORIGINS` | Recommended in prod | Comma-separated Origins for CORS (e.g. `https://corag.app`). When empty, the Function reflects the request Origin — tighten for production. |
