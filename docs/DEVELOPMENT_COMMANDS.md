...
- Starts Astro development server at `http://localhost:9999`
...
When using the devcontainer, the host port is mapped to **9999** (not 9999) to avoid conflict with macOS AirPlay Receiver. Access the dev server at `http://localhost:9999`.
